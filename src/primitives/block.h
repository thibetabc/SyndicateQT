...
public:
    ...
    // syndicate: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // syndicate: two types of block: proof-of-work or proof-of-stake
    ...
    // syndicate: get max transaction timestamp
