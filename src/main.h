...
static const int64_t STATIC_POS_REWARD = 10 * COIN; //Constant reward of 10 SYNX, 5 per.
...
static const int64_t MAX_MONEY = 25000000 * COIN; // 9,950,000 Million from POW
