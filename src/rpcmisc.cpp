...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total walle balance of the wallet (excluding zerocoins)\n"
...
/*
            "  \"zSYNXsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zSYNX denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zSYNX denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zSYNX denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zSYNX denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zSYNX denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zSYNX denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zSYNX denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zSYNX denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zSYNX denominations\n"
            "  }\n"
*/
            "  \"keypoololdest\": xxxxxx,    (numeric) the timestamp (seconds since GMT epoch) of the oldest pre-generated key in the key pool\n"
            "  \"keypoolsize\": xxxx,        (numeric) how many new keys are pre-generated\n"
            "  \"unlocked_until\": ttt,      (numeric) the timestamp in seconds since epoch (midnight Jan 1 1970 GMT) that the wallet is unlocked for transfers, or 0 if the wallet is locked\n"
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in walle/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in walle/kb\n"
...
/* disabled in this version
    ...
    obj.push_back(Pair("zSYNXsupply", zpivObj));
*/
#ifdef ENABLE_WALLET
    if (pwalletMain) {
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"walleaddress\"\n"
            "\nReturn information about the given walle address.\n"
            "\nArguments:\n"
            "1. \"walleaddress\"     (string, required) The walle address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"walleaddress\", (string) The walle address validated\n"
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2) {
        string msg = "createmultisig nrequired [\"key\",...]\n"
                     ...
                     "2. \"keys\"       (string, required) A json array of keys which are walle addresses or hex-encoded public keys\n"
                     "     [\n"
                     "       \"key\"    (string) walle address or hex-encoded public key\n"
                     "       ,...\n"
                     "     ]\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"walleaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"walleaddress\"  (string, required) The walle address to use for the signature.\n"
