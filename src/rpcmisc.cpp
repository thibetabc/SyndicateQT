...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total syndicate balance of the wallet (excluding zerocoins)\n"
...
*/
            ...
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in syndicate/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in syndicate/kb\n"
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nReturn information about the given syndicate address.\n"
            "\nArguments:\n"
            "1. \"syndicateaddress\"     (string, required) The syndicate address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"syndicateaddress\", (string) The syndicate address validated\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"syndicateaddress\"  (string, required) The syndicate address to use for the signature.\n"
