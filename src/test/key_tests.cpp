...
static const CSyndicateAddress addr1 ("gPdX9XjivUVeT3KNvZi4fqmSCxc7snkoJi");
static const CSyndicateAddress addr2 ("gLHZvB1Geqq3jDhPx2fVcaqeeiETUxptns");
static const CSyndicateAddress addr1C("gJC9vSpDbNQkZi9JrYgWxGhLaKUtWSXYzH");
static const CSyndicateAddress addr2C("g6Zzx2YE9J9MVcNsMpQDovz8QndFxd8zj9");
...
/*  Generate new keys as follows:
    ...
    printf("CSyndicateSecret(newKey1).ToString()): [%s]\n", CSyndicateSecret(newKey1).ToString().c_str());
    printf("newAddress1: [%s]\n", newAddress1.ToString().c_str());    
*/    
    
    CSyndicateSecret bsecret1, bsecret2, bsecret1C, bsecret2C, baddress1;
