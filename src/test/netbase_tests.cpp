...
{
    BOOST_CHECK(TestSplitHost("www.syndicate.org", "www.syndicate.org", -1));
    BOOST_CHECK(TestSplitHost("[www.syndicate.org]", "www.syndicate.org", -1));
    BOOST_CHECK(TestSplitHost("www.syndicate.org:80", "www.syndicate.org", 80));
    BOOST_CHECK(TestSplitHost("[www.syndicate.org]:80", "www.syndicate.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:12705", "::ffff:127.0.0.1", 12705));
    BOOST_CHECK(TestSplitHost("[::]:12705", "::", 12705));
    BOOST_CHECK(TestSplitHost("::12705", "::12705", -1));
    BOOST_CHECK(TestSplitHost(":12705", "", 12705));
    BOOST_CHECK(TestSplitHost("[]:12705", "", 12705));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:12705", "127.0.0.1:12705"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:12705", "[::]:12705"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
