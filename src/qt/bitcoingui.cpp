                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SYNDICATE Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SYNDICATE address"));
...
/*
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zSYNX"));
...
//    connect(privacyAction, SIGNAL(triggered()), this, SLOT(gotoPrivacyPage()));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SYNDICATE Core"), this);
    aboutAction->setStatusTip(tr("Show information about SYNDICATE Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SYNDICATE"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SYNDICATE addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SYNDICATE addresses"));
    ...
    openAction->setStatusTip(tr("Open a SYNDICATE: URI or payment request"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SYNDICATE Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("SYNDICATE Core"); // default title
