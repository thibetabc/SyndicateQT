...
{
    return QCoreApplication::translate("walle-core", psz).toStdString();
}
...
static void initTranslations(QTranslator& qtTranslatorBase, QTranslator& qtTranslator, QTranslator& translatorBase, QTranslator& translator)
{
    ...
    // Load e.g. bitcoin_de.qm (shortcut "de" needs to be defined in walle.qrc)
    if (translatorBase.load(lang, ":/translations/"))
        QApplication::installTranslator(&translatorBase);

    // Load e.g. bitcoin_de_DE.qm (shortcut "de_DE" needs to be defined in walle.qrc)
...
/// 2. Basic Qt initialization (not dependent on parameters or configuration)
    ...
    Q_INIT_RESOURCE(walle_locale);
    Q_INIT_RESOURCE(walle);
    ...
    /// 6. Determine availability of data directory and parse walle.conf
    ...
    // walle: links repeatedly have their payment requests routed to this process:
