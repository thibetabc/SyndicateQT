...
/** Syndicate unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class SyndicateUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit SyndicateUnits(QObject *parent);
...
typedef SyndicateUnits::Unit SyndicateUnit;
