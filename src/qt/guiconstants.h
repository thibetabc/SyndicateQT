...
/* Walle GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Walle"
#define QAPP_ORG_DOMAIN "synx.online"
#define QAPP_APP_NAME_DEFAULT "Walle-Qt"
#define QAPP_APP_NAME_TESTNET "Walle-Qt-testnet"
