 ...
 * The Syndicate Developers 2011-2012
 */
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/syndicate_testnet"));
            setWindowIcon(QIcon(":icons/syndicate_testnet"));
#else
...
void SyndicateGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    ...
    QString strMessage = tr("This transaction is over the size limit. You can still send it for a fee of %1, "
        ...
        "Do you want to pay the fee?").arg(SyndicateUnits::formatWithUnit(clientModel->getOptionsModel()->getDisplayUnit(), nFeeRequired));
    ...
    notificator->notify(Notificator::Information,
                        (amount)<0 ? tr("Sent transaction") :
                          ...
                          tr("Date: %1\n"
                             ...
                             "Address: %4\n")
                          .arg(date)
                          .arg(SyndicateUnits::formatWithUnit(walletModel->getOptionsModel()->getDisplayUnit(), amount, true))
                          .arg(type)
                          .arg(address), icon);
}
...
void SyndicateGUI::gotoMultisigPage()
{
    multisigPage->show();
