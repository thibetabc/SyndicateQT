...
#   c) node1 mines 32 blocks, so now node 0 has 60001 synx, node 1 has 4250 synx, node2 has none.
#   d) node0 sends 601 synx to node2, in two transactions (301 synx, then 300 synx).
