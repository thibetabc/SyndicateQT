Contributing to Walle Core
============================

The Walle Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Walle Core project, and is not to be
confused with overall Walle Network Protocol consensus changes.

Whether a pull request is merged into Walle Core rests with the project merge
...
Patches that change Walle consensus rules are considerably more involved than
...
Where a patch set proposes to change the Walle consensus, it must have been
...
The project leader is the release manager for each Walle Core release.
