...
# TestNode: A peer we use to send messages to syndicated, and store responses.
...
class CompactBlocksTest(SyndicateTestFramework):
    ...
    # This test actually causes syndicated to (reasonably!) disconnect us, so do this last.
    ...
    # Test that syndicated requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for syndicated to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # syndicated will not send blocktxn responses for blocks whose height is
