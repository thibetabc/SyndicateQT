...
In order to support loading of multiple wallets in syndicate-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is syndicate.cpp.
...
Changes to syndicate.cpp
----------------------
syndicate.cpp is the entry point into syndicate-qt, and as such, will require some minor modifications to provide hooks for
