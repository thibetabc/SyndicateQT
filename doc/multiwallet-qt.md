...
In order to support loading of multiple wallets in walle-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is walle.cpp.
...
Changes to walle.cpp
----------------------
walle.cpp is the entry point into walle-qt, and as such, will require some minor modifications to provide hooks for
