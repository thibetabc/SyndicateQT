...
### Build and sign PIVX Core for Linux, Windows, and OS X:
    ...
    ./bin/gbuild --memory 3000 --commit syndicate=v${VERSION} ../syndicate/contrib/gitian-descriptors/gitian-win.yml
...
- Detached signatures will then be committed to the [syndicate-detached-sigs](https://github.com/PIVX-Project/syndicate-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
