...
This means one can have an always-on walled instance running, and another local walled/walle-qt instance which connects to this node and receives blocks from it.
