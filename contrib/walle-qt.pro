...
RESOURCES += src/qt/walle.qrc src/qt/walle_locale.qrc

TRANSLATIONS += src/qt/locale/walle_bg.ts \
                src/qt/locale/walle_de.ts \
                src/qt/locale/walle_en.ts \
                src/qt/locale/walle_es.ts \
                src/qt/locale/walle_fi.ts \
                src/qt/locale/walle_fr.ts \
                src/qt/locale/walle_it.ts \
                src/qt/locale/walle_ja.ts \
                src/qt/locale/walle_pl.ts \
                src/qt/locale/walle_pt.ts \
                src/qt/locale/walle_ru.ts \
                src/qt/locale/walle_sk.ts \
                src/qt/locale/walle_sv.ts \
                src/qt/locale/walle_vi.ts \
                src/qt/locale/walle_zh_CN.ts \
                src/qt/locale/walle_zh_TW.ts
