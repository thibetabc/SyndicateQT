...
Contains files used to package syndicated/syndicate-qt
...
Utilities to generate test vectors for the data-driven Syndicate tests.

### [Verify Binaries](/contrib/verifybinaries) ###
This script attempts to download and verify the signature file SHA256SUMS.asc from syndicate.org.
